...
class MeuTokenJWT
{
    ...
    public function gerarToken($parametro_claims)
    {
        ...
        $objPayload->prof = $parametro_claims->prof;
        $objPayload->nameEscola = $parametro_claims->nameEscola;


        // Private claims
        $objPayload->idEscola = isset($parametro_claims->idEscola) ? $parametro_claims->idEscola : null;
